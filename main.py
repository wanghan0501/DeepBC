...
model_config = ModelConfig(model_name='inception_resnet_v2',
                           dropout_keep_prob=0.70,
                           num_classes=3,
                           img_shape=(299, 299, 3),
                           batch_size=16,
                           max_epoch=30,
                           plot_batch=25,
                           train_data_path='data/tfdata/2018-01-03 19:06:59.686644/bc_train.tfrecords',
                           test_data_path='data/tfdata/2018-01-03 19:06:59.686644/bc_test.tfrecords')
...
# set train
model_config.train_data_length = 581
model_config.test_data_length = 250
